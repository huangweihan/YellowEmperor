...
public class FkMessageConstant {
    ...
    // 服开 - 资源派单报文查询
    public static final String RES_SEND_ORDER_SQL = "SELECT t3.iom_xml AS IOM_XML FROM om_order t1,wo_work_order t2,inf_iom_log t3 " +
    ...
    // 服开 - 综调派单报文查询
    public static final String ZD_SEND_ORDER_SQL = "SELECT t3.iom_xml AS IOM_XML FROM om_order t1,wo_work_order t2,inf_iom_log t3 " +
